...
window.addEventListener("load", function(){ //funktion der udføres efter load//
  ...
  let obj1 = {name:"samber season", pics:["amber-season.jpg","amber-season-hover.jpg"]}
  let obj2 = {name:"amber caramel", pics:["amber-caramel.jpg","amber-caramel-hover.jpg"]}
  let obj3 = {name:"liquorice", pics:["lisquorice.jpg","liquorice-hover.jpg"]}
